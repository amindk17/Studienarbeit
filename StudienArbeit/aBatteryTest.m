...
bat1.SOC=25;
bat1.Temperatur=25;
bat1.NumberOfCellsPll=2;
bat1.NumberOfCellsSerie=100;
%---- LookUps ----%
bat1.Ri_soc_LookUp=Ri_soc_LookUp;
bat1.Imax_LookUp=Imax_LookUp;
bat1.VoltSoc_LookUp=VoltSoc_LookUp;
bat1.TempCorrection_LookUp=TempCorrection_LookUp;
%---- Simulation ----%
dt=1;Pmax=10000;withplot=1;tunit='min';
[bat1.simC,bat1.simI,bat1.simP] = bat1.simulateCharge(dt,Pmax,withplot,tunit);