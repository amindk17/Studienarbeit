...
Cmax = 50000;                       % Capacity in Ah
NumberOfCellsPll = 2;           % Number of Paralell Cells
NumberOfCellsReihe=100 ;          % Number of Serie Cells
Rc = 0.00736;                   % Rc in Ohm (!!!! recheck !!!!)
dt=1;                        % in s
pmax=30000;                         % Charger input Power in W
...
function [soc,It,P,finish] = calcNewSoc(soc,Cmax,T,dt,NumberOfCellsPll,NumberOfCellsSerie,Pmax)
    ...
    It = calcI(soc,Cmax,Ri,Rc,NumberOfCellsSerie,NumberOfCellsPll,Pmax,dt,Imax);
